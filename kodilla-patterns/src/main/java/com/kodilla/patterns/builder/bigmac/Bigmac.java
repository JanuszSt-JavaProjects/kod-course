...
public final class Bigmac {
    ...
    public static class BigmacPreparator {
        ...
        public BigmacPreparator bun(Bun bun) {
            this.bun = bun;
            return this;
        }

        public BigmacPreparator burgers(int burgers) {
            this.burgers = burgers;
            return this;
        }

        public BigmacPreparator sauce(Sauce sauce) {
            this.sauce = sauce;
            return this;
        }

        public BigmacPreparator ingredient(Ingredient ingredient) {
